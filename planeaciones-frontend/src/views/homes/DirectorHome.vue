  ...
  <AppShell>
    ...
    <section class="hero-tilt" @mousemove="handleHeroMouseMove" @mouseleave="handleHeroMouseLeave" ref="heroRef">
      <div class="hero-content">
        <div class="hero-tag">
          <Building2 :size="14" class="spin-slow" /> Director Académico
        </div>
        <h1>Panel del <span class="accent">Director</span></h1>
        <p>Supervisa, evalúa y toma las decisiones finales sobre las secuencias didácticas de tu carrera desde este panel.</p>
      </div>
    ...
    <div class="sec">
      <div class="sec-hdr">
        ...
        <div>
          ...
          <p>Navega directamente a tus tareas pendientes.</p>
        </div>
      </div>

      <div class="g2">
        <!-- Tarjeta: Validación de Secuencias -->
        <router-link :to="{ name: 'secuencias-director' }" class="card-tilt">
          <div class="card-inner">
            <div class="card-icon-wrap c-amber">
              <ShieldCheck :size="28" />
            </div>
            <div class="card-info">
              <h3>Validación de Secuencias</h3>
              <p>Consulta las secuencias de tu carrera que están pendientes de tu revisión y decisión final.</p>
            </div>
...
.hero-tag {
  ...
  font-size: 12.5px;
  font-weight: 700;
  color: var(--warning); /* Tinte ámbar/naranja para el Director */
  margin-bottom: 18px;
  border: 1px solid var(--border);
...
.card-tilt:hover {
  ...
  border-color: var(--warning); /* Borde ámbar al pasar el cursor */
}
